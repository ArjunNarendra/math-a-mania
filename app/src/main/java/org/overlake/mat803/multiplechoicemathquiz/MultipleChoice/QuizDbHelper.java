...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        Question q1 = new Question("What is the capital of India?",
                "Bangalore", "Chennai", "New Delhi", 3,
                Question.DIFFICULTY_EASY, Category.GEOGRAPHY);
        addQuestion(q1);
        Question q2 = new Question("What is the Earth's largest continent?",
                "Africa", "Asia", "Antartica", 2,
                Question.DIFFICULTY_MEDIUM, Category.GEOGRAPHY);
        addQuestion(q2);
        Question q3 = new Question("Which country has the most natural lakes?",
                "Canada", "United States", "India", 1,
                Question.DIFFICULTY_HARD, Category.GEOGRAPHY);
        addQuestion(q3);
        Question q4 = new Question("What is 10 * 10?",
                "95", "20", "100", 3,
                Question.DIFFICULTY_EASY, Category.MATH);
        addQuestion(q4);
        Question q5 = new Question("What is the square root of 64?",
                "8", "7", "6", 1,
                Question.DIFFICULTY_MEDIUM, Category.MATH);
        addQuestion(q5);
        Question q6 = new Question("What is the highest degree term of a cubic polynomial?",
                "6", "3", "9", 2,
                Question.DIFFICULTY_HARD, Category.MATH);
        addQuestion(q6);
        Question q7 = new Question("What is 7 % 5?",
                "0", "2", "1", 2,
                Question.DIFFICULTY_EASY, Category.PROGRAMMING);
        addQuestion(q7);
        Question q8 = new Question("Which of these is a programming language?",
                "Dog", "Cat", "Python", 3,
                Question.DIFFICULTY_MEDIUM, Category.PROGRAMMING);
        addQuestion(q8);
        Question q9 = new Question("What is a key component of all Android Studio applications?",
                "Activity", "Engine", "Motor", 1,
